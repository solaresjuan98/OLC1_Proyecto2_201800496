...
INTERFACE: token_public token_interface token_Identifier 
           token_left_brace LIST_DEC_FUNC token_right_brace
           {
               $$ = new Node("INTERFACE", "NON_TERMINAL");
               $$.addChild(new Node($1, "interface"));// don't translate
               $$.addChild(new Node($3, "id_interface"));// don't translate
           } 
    ; //| error {console.log(" (INTERFACE) Sintax error [ row: " + this._$.first_line + ", column: " + this._$.first_column +" ] ");} ;


LIST_DEC_FUNC: LIST_DEC_FUNC DEC_FUNC
             {
                $$ = new Node("LIST_DEC_FUNC", "NON_TERMINAL"); 
                $$.addChild($1);
                $$.addChild($2); 
             }
             | DEC_FUNC
...
DEC_FUNC : token_public METHOD_DATA_TYPE token_Identifier 
           token_left_parenthesis PARAMETERS_LIST token_right_parenthesis token_semicolon 
           {
               $$ = new Node("DEC_FUNC", "NON_TERMINAL"); 
           } ;
...
INSTRUCTIONS : VAR_DECLARATION { $$ = new Node("VAR_LIST", "NON_TERMINAL"); $$.addChild($1); }
             ...
             | DEC_INC {$$ = new Node("DEC_INC", "NON_TERMINAL"); $$.addChild($1);}
             | ML_COMMENTARY { $$ = new Node("ML_C", "NON_TERMINAL"); $$.addChild($1); }
             | SL_COMMENTARY { $$ = new Node("SL_C", "NON_TERMINAL"); $$.addChild($1); }
...
SL_COMMENTARY: sl_commentary INSTRUCTIONS
                {
                    $$ = new Node("sl_comment", ""); $$.addChild(new Node($1, "sl_comment"));
                };
...
PRINT_INST : token_System token_point token_out 
           ...
           | token_System token_point token_out 
             token_point token_println token_left_parenthesis 
             text_string_sq token_right_parenthesis token_semicolon
           {
                $$ = new Node("print", "NON_TERMINAL");
           ...
           | token_System token_point token_out 
             token_point token_println token_left_parenthesis 
             text_string_sq token_plus CONCAT token_right_parenthesis token_semicolon
           {
                $$ = new Node("print", "NON_TERMINAL");
                $$.addChild(new Node($5, "println"));
                $$.addChild(new Node($6, "("));
           ...
           | token_System token_point token_out 
             token_point token_println token_left_parenthesis 
             text_string_qm token_plus CONCAT token_right_parenthesis token_semicolon
           {
                $$ = new Node("print", "NON_TERMINAL");
                $$.addChild(new Node($5, "println"));
                $$.addChild(new Node($6, "("));
...
CONCAT: text_string_sq token_plus CONCAT
        {
            $$ = new Node("CONCAT", "NON_TERMINAL");
            $$.addChild(new Node($1, "text_string"));
            $$.addChild(new Node($2, "+"));
            $$.addChild($3);
        } 
        |text_string_qm token_plus CONCAT
        {
            $$ = new Node("CONCAT", "NON_TERMINAL");
            $$.addChild(new Node($1, "text_string"));
            $$.addChild(new Node($2, "+"));
        ...
        |token_Identifier token_plus CONCAT
        {
            $$ = new Node("CONCAT", "NON_TERMINAL");
            $$.addChild(new Node($1, "id"));//ojo aqui
            $$.addChild(new Node($2, "+"));
            $$.addChild($3);
        }
        |METHOD_CALL2 token_plus CONCAT
        {
            $$ = new Node("CONCAT", "NON_TERMINAL");
            $$.addChild($1);
            $$.addChild(new Node($2, "+"));
        ...
        {
            $$ = new Node("CONCAT", "NON_TERMINAL");
            $$.addChild(new Node($1, "token_Identifier"));
        }
        | METHOD_CALL2 
        {
            $$ = new Node("CONCAT", "NON_TERMINAL");
...
VAR_DECLARATION : DATA_TYPE token_Identifier token_equal E token_semicolon 
                ...
                | DATA_TYPE token_Identifier token_equal text_string_sq token_semicolon
                {
                     $$.addChild(new Node("Type", "NON_TERMINAL"));
                     $$.addChild(new Node($2, "id"));
                     $$.addChild(new Node($3, "equal"));
                ...
                | DATA_TYPE token_Identifier token_equal E token_comma VAR_LIST
                 ...
                 | DATA_TYPE token_Identifier token_equal text_string_qm token_comma VAR_LIST
                 {
                     $$.addChild(new Node("Type", "NON_TERMINAL"));
                     $$.addChild(new Node($2, "id"));
                     $$.addChild(new Node($3, "equal"));
                 ...
                 | DATA_TYPE token_Identifier token_equal text_string_sq token_comma VAR_LIST
                 {
                     $$.addChild(new Node("Type", "NON_TERMINAL"));
                     $$.addChild(new Node($2, "id"));
                     $$.addChild(new Node($3, "equal"));
...
VAR_LIST: token_Identifier token_equal E token_comma VAR_LIST
        ...
        | token_Identifier token_equal text_string_qm token_comma VAR_LIST
        {
            $$ = new Node("VAR_LIST", "NON_TERMINAL");
            $$.addChild(new Node($1, "var_id"));
            $$.addChild(new Node($2, "="));
            $$.addChild(new Node($3, "text_string"));
            $$.addChild(new Node($4, ","));
            $$.addChild($5);
        }
        | token_Identifier token_equal text_string_sq token_comma VAR_LIST
        {
            $$ = new Node("VAR_LIST", "NON_TERMINAL");
            $$.addChild(new Node($1, "var_id"));
            $$.addChild(new Node($2, "="));
...
ASSIGNATION: token_Identifier token_equal E token_semicolon 
            ...
            | token_Identifier token_equal text_string_qm token_semicolon 
            {
                $$ = new Node("Assignation", "NON_TERMINAL");
                $$.addChild(new Node($1, "var_id"));
                $$.addChild(new Node($2, "equal"));
            ...
            | token_Identifier token_equal text_string_sq token_semicolon 
            {
                $$ = new Node("Assignation", "NON_TERMINAL");
                $$.addChild(new Node($1, "var_id"));
                $$.addChild(new Node($2, "equal"));
...
METHOD_CALL2: token_Identifier token_left_parenthesis PARAMETER_LIST token_right_parenthesis
            {
                $$ = new Node("method_call", "NON_TERMINAL");
                $$.addChild(new Node($1, "method_id"));
                $$.addChild(new Node($2, "("));
...
FOR_DEF: VAR_DECLARATION E token_semicolon E
        {
            $$ = new Node("FOR_DEF", "NON_TERMINAL");
            $$.addChild($1);
            $$.addChild($2);
            $$.addChild(new Node($3, ";_"));
            $$.addChild($4);
            
        };

DEC_INC: token_Identifier token_plus token_plus { $$ = new Node("DEC_INC", "");  $$.addChild(new Node($1, "id")); $$.addChild(new Node($2, "+")); $$.addChild(new Node($3, "+")); }
       | token_Identifier token_minus token_minus { $$ = new Node("DEC_INC", ""); $$.addChild(new Node($1, "id")); $$.addChild(new Node($2, "-")); $$.addChild(new Node($3, "-")); } ;
